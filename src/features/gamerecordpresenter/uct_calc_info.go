...
func CreatePrintingOfCalc(text_io1 i_text_io.ITextIO, readonlyGameSettingsModel *gamesettings.ReadonlyGameSettingsModel) *func(*position.Position, int, models.Point, float64, int) {
	// UCT計算中の表示
...
func CreatePrintingOfCalcFin(text_io1 i_text_io.ITextIO, readonlyGameSettingsModel *gamesettings.ReadonlyGameSettingsModel) *func(*position.Position, models.Point, float64, int, int, int) {
	// UCT計算後の表示
