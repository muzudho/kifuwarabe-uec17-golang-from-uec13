...
import (
	...
	gamesettings "github.com/muzudho/kifuwarabe-uec17-golang-from-uec13/src/data_transfer_objects/gamesettingstoml"
)
...
// 2: 白石
// 3: 壁
func GetBoardArray(gamesettings1 *gamesettings.GameSettings) []color.Color {
